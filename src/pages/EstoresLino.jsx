...
const EstoresLino = () => {
  ...
  const calculatePrice = () => {
    ...
    const calculatedPrice = (totalWidth * 0.35) + (totalWidth * 0.2);
    setPrice(calculatedPrice.toFixed(2));
  };

  return (
    <div style={{
      backgroundImage: `url(${estoresLino})`,
      ...
      >
        ...
        <div style={{ marginBottom: '10px' }}>
          <label>Ancho (cm sin comas): </label>
          <input
            type="number"
            value={width}
        ...
        <div style={{ marginBottom: '20px' }}>
          <label>Alto (cm sin comas. Máx 270): </label>
          <input
            type="number"
            value={height}
