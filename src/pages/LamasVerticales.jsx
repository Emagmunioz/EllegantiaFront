...
import lamasVerticalesImg from '../assets/pagina-lamas.jpg';
...
const LamasVerticales = () => {
  ...
  const calculatePrice = () => {
    ...
    const totalHeight = parseFloat(height); // Alto total
    const calculatedPrice = (totalWidth * totalHeight/100) * 0.9; // Fórmula de cálculo
    setPrice(calculatedPrice.toFixed(2)); // Redondea a 2 decimales
  };

  return (
    <div style={{
      backgroundImage: `url(${lamasVerticalesImg})`,
      ...
      >
        ...
        <div style={{ marginBottom: '10px' }}>
          <label>Ancho (cm sin coma, mín 60): </label>
          <input
            type="number"
            value={width}
...
export default LamasVerticales;