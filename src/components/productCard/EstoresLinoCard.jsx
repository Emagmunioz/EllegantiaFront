...
import estoresLino from '../../assets/estoresLino.jpg';

const EstoresLinoCard = () => {
    ...
    <Card className="h-100 product-card" style={{
      ...
      <div className="card-image-container" style={{ position: 'relative' }}>
        ...
        <div className="card-title-overlay" style={{
          ...
          <h3 className="mb-0">Estores de lino</h3>
        </div>
      </div>
      ...
      <Card.Body className="d-flex flex-column" style={{ padding: '1.25rem' }}>
        ...
        <div className="d-grid gap-2 mt-auto">
          ...
          <Button 
            variant="dark"
            onClick={() => navigate('/calculate-price?product=estores-lino')}
            style={{
...
export default EstoresLinoCard;