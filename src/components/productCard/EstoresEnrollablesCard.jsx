...
import estoresGaleria from '../../assets/estoresGaleria.jpg';

const EstoresEnrollablesCard = () => {
    ...
    <Card className="h-100 product-card" style={{
      ...
      <div className="card-image-container" style={{ position: 'relative' }}>
        <Card.Img 
          variant="top" 
          src={estoresGaleria} 
          alt="Estores Enrollables Screen"
          style={{
            height: '200px',
            objectFit: 'cover',
            width: '100%'
        ...
        <div className="card-title-overlay" style={{
          ...
          <h3 className="mb-0">Estores Enrollables Screen</h3>
        </div>
      </div>
      ...
      <Card.Body className="d-flex flex-column" style={{ padding: '1.25rem' }}>
        ...
        <div className="d-grid gap-2 mt-auto">
          <Button 
            ...
            onClick={() => navigate('/estores-enrollables')}
            style={{
              borderRadius: '4px',
              fontWeight: '500'
            }}
          ...
          <Button 
            variant="dark"
            onClick={() => navigate('/calculate-price?product=estores-enrollables')}
            style={{
...
export default EstoresEnrollablesCard;