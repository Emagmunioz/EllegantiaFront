...
import linoArrastre from '../../assets/linoArrastre.jpg';

const LinoArrastreCard = () => {
    ...
    <Card className="h-100 product-card" style={{
      ...
      <div className="card-image-container" style={{ position: 'relative' }}>
        <Card.Img 
          variant="top" 
          src={estoresGaleria} 
          alt="Visillos lino con arrastre"
          style={{
            height: '200px',
            objectFit: 'cover',
            width: '100%'
        ...
        <div className="card-title-overlay" style={{
          ...
          <h3 className="mb-0">Visillos de lino con arrastre</h3>
        </div>
      </div>
      ...
      <Card.Body className="d-flex flex-column" style={{ padding: '1.25rem' }}>
        ...
        <div className="d-grid gap-2 mt-auto">
          ...
          <Button 
            variant="dark"
            onClick={() => navigate('/calculate-price?product=LinoArrastre')}
            style={{
...
export default LinoArrastreCard;