...
import panelesJaponeses from '../../assets/panelesgris.jpg';

const PanelesJaponesesCard = () => {
    ...
    <Card className="h-100 product-card" style={{
      ...
      <div className="card-image-container" style={{ position: 'relative' }}>
        ...
        <div className="card-title-overlay" style={{
          ...
          <h3 className="mb-0">Paneles Japoneses Screen</h3>
        </div>
      </div>
      ...
      <Card.Body className="d-flex flex-column" style={{ padding: '1.25rem' }}>
        ...
        <div className="d-grid gap-2 mt-auto">
          <Button 
            ...
            onClick={() => navigate('/PanelesJaponeses')}
            style={{
              borderRadius: '4px',
              fontWeight: '500'
            }}
          ...
          <Button 
            variant="dark"
            onClick={() => navigate('/calculate-price?product=PanelesJaponeses')}
            style={{
...
export default PanelesJaponesesCard;